...
| Fake and final documentation | Commit containing this report | Fake organization, linked architecture map and verification results |
...
There were no test failures or errors. The baseline was 279 reported cases with the same four live skips. The increase is the 16 shared-contract cases; no original cases were removed.
